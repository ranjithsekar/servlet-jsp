...
@WebServlet(urlPatterns = { "/adminSuper" })
public class AdminSuperUser extends HttpServlet {
  ...
  private void handleRequest(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
    ...
    out.write("<p style='color: green; font-size: large;'>Welcome, Super Administrator!</p>");
    out.write("</body></html>");
    out.close();
  }
